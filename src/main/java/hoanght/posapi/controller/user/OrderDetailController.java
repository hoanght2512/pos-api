...
public class OrderDetailController {
    ...
    public ResponseEntity<DataResponse<OrderDetailResponse>> updateOrderDetail(@PathVariable Long orderDetailId, @Valid @RequestBody OrderDetailUpdateRequest orderDetailUpdateRequest) {
        OrderDetail orderDetail = orderDetailService.updateOrderDetail(orderDetailId, orderDetailUpdateRequest);
        OrderDetailResponse response = orderDetailAssembler.toModel(orderDetail);
